        ...
        <g id="right">
          <g id="组_380" data-name="组 380">
            ...
            <g id="dots_b">
              ...
              <!-- 光点动画 -->
              <animateMotion href="#dots28" dur="5s" rotate="auto" repeatCount="indefinite" begin="0s">
                <mpath href="#line_b_3"></mpath>
              </animateMotion>
              <animateMotion href="#dots26" dur="5s" rotate="auto" repeatCount="indefinite" begin="3s">
                <mpath href="#line_b_3"></mpath>
              </animateMotion>
              <animateMotion href="#dots25" dur="5s" rotate="auto" repeatCount="indefinite" begin="0s">
                <mpath href="#line_b_2"></mpath>
              </animateMotion>
              <animateMotion href="#dots24" dur="5s" rotate="auto" repeatCount="indefinite" begin="3s">
                <mpath href="#line_b_2"></mpath>
              </animateMotion>
              <animateMotion href="#dots21" dur="5s" rotate="auto" repeatCount="indefinite" begin="0s">
                <mpath href="#line_b_1"></mpath>
              </animateMotion>
              <animateMotion href="#dots14" dur="5s" rotate="auto" repeatCount="indefinite" begin="3s">
                <mpath href="#line_b_1"></mpath>
              </animateMotion>
            </g>
            <g id="dots_o">
              ...
              <circle
                ...
                r="2.781"
              />
              <use id="dots12" x="-11" y="-11" xlink:href="#image" />
              <use id="dots11" x="-11" y="-11" xlink:href="#image" />
              <use id="dots10" x="-11" y="-11" xlink:href="#image" />
              <use id="dots09" x="-11" y="-11" xlink:href="#image" />
              <use id="dots08" x="-11" y="-11" xlink:href="#image" />
              <use id="dots07" x="-8" y="-8" xlink:href="#image-2" />
              <use id="dots06" x="-8" y="-8" xlink:href="#image-2" />
              <use id="dots05" x="-8" y="-8" xlink:href="#image-2" />
              <use id="dots04" x="-8" y="-8" xlink:href="#image-2" />
              <use id="dots03" x="-8" y="-8" xlink:href="#image-2" />
              <use id="dots02" x="-8" y="-8" xlink:href="#image-2" />
              <use id="dots01" x="-8" y="-8" xlink:href="#image-2" />

              <!-- 光点动画 -->
              <template v-for="(id, index) in ['12', '07', '06', '05']" :key="id">
                <animateMotion :href="`#dots${id}`"  dur="5s" rotate="auto" repeatCount="indefinite" :begin="`${index}s`">
                  <mpath href="#line_o_3"></mpath>
                </animateMotion>
              </template>
              <template v-for="(id, index) in ['11', '10', '04', '03']" :key="id">
                <animateMotion :href="`#dots${id}`"  dur="5s" rotate="auto" repeatCount="indefinite" :begin="`${index}s`">
                  <mpath href="#line_o_2"></mpath>
                </animateMotion>
              </template>
              <template v-for="(id, index) in ['09', '08', '02', '01']" :key="id">
                <animateMotion :href="`#dots${id}`"  dur="5s" rotate="auto" repeatCount="indefinite" :begin="`${index}s`">
                  <mpath href="#line_o_1"></mpath>
                </animateMotion>
              </template>
            </g>
          </g>
...
<style scoped>
  ...
  #icon_earth_dongguan {
    animation: updown 1.5s infinite ease-in;
  }
  #icon_pie_shenzhen {
    animation: updown 2s infinite ease-in;
  }
